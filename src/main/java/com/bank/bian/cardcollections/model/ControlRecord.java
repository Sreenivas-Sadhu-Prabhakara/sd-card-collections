package com.bank.bian.cardcollections.model;
...
/**
 * The BIAN control record for this service domain: "Card Collection Case Procedure".
 *
 ...
 * to its asset type (Card Collection Case). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Card Collection Case Procedure";
